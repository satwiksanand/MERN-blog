        ...
        <div className="col-span-2 flex flex-col justify-evenly gap-3 p-4 md:col-start-1">
          ...
          <div className="flex w-full flex-col gap-6 p-2">
            ...
            <input
              ...
              name="bannerImage"
              id="bannerImage"
              className="w-full rounded-lg bg-[#262626]"
          ...
          <div className="hidden md:block">
            <div className="max-w-md rounded-lg border border-gray-200 bg-[#444] shadow dark:border-gray-700 dark:bg-gray-800">
              ...
              <div className="p-5">
                ...
                <div className="text-md inline-flex items-center rounded-lg bg-blue-700 px-3 py-2 text-center font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Read more
                  <svg
